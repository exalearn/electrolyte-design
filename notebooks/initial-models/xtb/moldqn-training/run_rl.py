...
from moldesign.sample.rl.envs.actions import MoleculeActions
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--epsilon-min', help='Final value of epsilon', default=0.25, type=float)
    ...
    agent = DQNFinalState(env, gamma=args.gamma, preprocessor=MorganFingerprints(args.fingerprint_size),
                          batch_size=args.batch_size, epsilon=args.epsilon, epsilon_min=args.epsilon_min,
