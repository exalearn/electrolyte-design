...
if __name__ == "__main__":
    ...
    train_loader = make_data_loader(train_path, shuffle_buffer=len(train_data), cache=True, output_property='energy',
                                    batch_size=args.batch_size)
    test_loader = make_data_loader(os.path.join('..', 'test_data.proto'),
                                   batch_size=args.batch_size, output_property='energy')
